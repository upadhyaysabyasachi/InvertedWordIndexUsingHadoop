...
//import testxml.InvertedIndex.SortingPartitioner;
...
public class in_index
{
  ...
  protected void map(LongWritable key, Text value,
    ...
    Logger log=Logger.getLogger("info");
      ...
      {
    	 // nameWeightPair+=token1.nextToken() + "=="+ token2.nextToken()+" "; 
    	  context.write(new Text(token1.nextToken()), new Text(filename));
      }
  ...
  public static String constructPropertyXml(Text name, Text value) {
    ...
    return sb.toString();
        ...
        public static void main(String[] args) throws Exception
        {
                ...
                job.setJarByClass(in_index.class);
                job.setOutputKeyClass(Text.class);
                job.setOutputValueClass(Text.class);

                job.setMapperClass(in_index.Map.class);
                job.setReducerClass(in_index.Reduce.class);
